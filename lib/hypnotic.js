/*** Generated by streamline 0.10.1 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function(exports) {
  ...
  ExecutionContext.prototype = {
    ...
    execute: function execute__1(n, _) { var prev, __this = this; var __frame = { name: "execute__1", line: 301 }; return __func(_, this, arguments, execute__1, 1, __frame, function __$execute__1() {
  ...
  function execute(n, x, _) { var a, c, f, i, j, r, s, t, u, v, matchDefault, break_loop, c2; var __frame = { name: "execute", line: 381 }; return __func(_, this, arguments, execute, 2, __frame, function __$execute() { return (function __$execute(__break) {
        ...
        case FOR: return (function __$execute(_) { var __1 = n.setup;
            if (!__1) { return _(null, __1); } ; return execute(n.setup, x, __cb(_, __frame, 111, 32, function ___(__0, __3) { var __2 = getValue(__3); return _(null, __2); }, true)); })(__cb(_, __frame, -380, 21, function __$execute() { return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$execute() { __more = false; return (function __$execute(_) { return (function __$execute(_) { var __2 = !n.condition;
                    if (__2) { return _(null, __2); } ; return execute(n.condition, x, __cb(_, __frame, 112, 44, function ___(__0, __4) { var __3 = getValue(__4); return _(null, __3); }, true)); })(__cb(_, __frame, -380, 21, _, true)); })(__cb(_, __frame, -380, 21, function ___(__0, __106) { if (__106) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$execute() { return execute(n.body, x, __cb(_, __frame, 114, 20, __then, true));
                          ...
                          if (!__2) { return _(null, __2); } ; return execute(n.update, x, __cb(_, __frame, 124, 37, function ___(__0, __4) { var __3 = getValue(__4); return _(null, __3); }, true)); })(__cb(_, __frame, -380, 21, function __$execute() { while (__more) { __loop(); }; __more = true; }, true)); }); }); } else { __break(); } ; }, true)); }); do { __loop(); } while (__more); __more = true; })(__break); }, true));
        ...
        case WHILE: return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$execute() { __more = false; return (function __$execute(_) { return (function __$execute(_) { var __3 = !n.condition;
                  if (__3) { return _(null, __3); } ; return execute(n.condition, x, __cb(_, __frame, 128, 44, function ___(__0, __5) { var __4 = getValue(__5); return _(null, __4); }, true)); })(__cb(_, __frame, -380, 21, _, true)); })(__cb(_, __frame, -380, 21, function ___(__0, __110) { if (__110) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$execute() { return execute(n.body, x, __cb(_, __frame, 130, 20, __then, true));
                        ...
                        if (!__3) { return _(null, __3); } ; return execute(n.update, x, __cb(_, __frame, 140, 37, function ___(__0, __5) { var __4 = getValue(__5); return _(null, __4); }, true)); })(__cb(_, __frame, -380, 21, function __$execute() { while (__more) { __loop(); }; __more = true; }, true)); }); }); } else { __break(); } ; }, true)); }); do { __loop(); } while (__more); __more = true; })(__break);
          ...
          return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$execute() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$execute() { return execute(n.tryBlock, x, __cb(_, __frame, 198, 16, __then, true));
                            ...
                            var __125 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$execute() { __more = false; if (__125) { i++; } else { __125 = true; } ; var __124 = 1; if (__124) { if ((i === j)) {
                                  ...
                                  return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$execute() { return (function __$execute(_) { var __5 = t.guard;
                                          ...
                                          if (!__5) { return _(null, __5); } ; return execute(t.guard, x, __cb(_, __frame, 212, 53, function ___(__0, __7) { var __6 = !getValue(__7); return _(null, __6); }, true)); })(__cb(_, __frame, -380, 21, function ___(__0, __16) { return (function __$execute(__then) { if (__16) { while (__more) { __loop(); }; __more = true; return; } else { __then(); } ; })(function __$execute() { return execute(t.block, x, __cb(_, __frame, 214, 28, __break, true));
        ...
        case RETURN: return (function __$execute(_) { var __6 = n.value;
            ...
            return (function __$execute(__then) { if (__6) { return execute(n.value, x, __cb(_, __frame, 235, 42, function ___(__0, __8) { var __7 = getValue(__8); return _(null, __7); }, true)); } else { __then(); } ; })(function __$execute() { return _(null, undefined); }); })(__cb(_, __frame, -380, 21, function ___(__0, __18) { x.result = __18; return _(RETURN);
          }, true));
        ...
        case HOOK: c = n.children;
          return (function __$execute(_) { return execute(c[0], x, __cb(_, __frame, 321, 25, function ___(__0, __8) {
              var __7 = getValue(__8); var __9 = __7; return (function __$execute(__then) { if (__9) { return execute(c[1], x, __cb(_, __frame, 321, 57, function ___(__0, __11) { var __10 = getValue(__11); return _(null, __10); }, true)); } else { __then(); } ; })(function __$execute() { return execute(c[2], x, __cb(_, __frame, 322, 54, function ___(__0, __13) {
                  var __12 = getValue(__13); return _(null, __12); }, true)); }); }, true)); })(__cb(_, __frame, -380, 21, function ___(__0, __25) { v = __25; return __break(); }, true));


        case OR: c = n.children;
          return (function __$execute(_) { return execute(c[0], x, __cb(_, __frame, 327, 25, function ___(__0, __9) {
              var __8 = getValue(__9); var __10 = __8; return (function __$execute(__then) { if (__10) { var __11 = __8; return _(null, __11); } else { __then(); } ; })(function __$execute() { return execute(c[1], x, __cb(_, __frame, 327, 58, function ___(__0, __13) { var __12 = getValue(__13); return _(null, __12); }, true)); }); }, true)); })(__cb(_, __frame, -380, 21, function ___(__0, __26) { v = __26; return __break(); }, true));


        case AND: c = n.children;
          return (function __$execute(_) { return execute(c[0], x, __cb(_, __frame, 332, 25, function ___(__0, __10) {
              var __9 = getValue(__10); var __11 = !__9; return (function __$execute(__then) { if (__11) { var __12 = __9; return _(null, __12); } else { __then(); } ; })(function __$execute() { return execute(c[1], x, __cb(_, __frame, 332, 58, function ___(__0, __14) { var __13 = getValue(__14); return _(null, __13); }, true)); }); }, true)); })(__cb(_, __frame, -380, 21, function ___(__0, __27) { v = __27; return __break(); }, true));
  ...
  var FOp = FunctionObject.prototype = {
    ...
    __call__: function __call____2(t, a, x, _) { var x2, f, __this = this; var __frame = { name: "__call____2", line: 1052 }; return __func(_, this, arguments, __call____2, 3, __frame, function __$__call____2() {
  ...
  if (!(("__call__" in Fp))) {
    definitions.defineProperty(Fp, "__call__", function __3(t, a, x, _) { var __this = this; var __frame = { name: "__3", line: 1155 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
  ...
  function evaluate(s, f, l, _) { var x; var __frame = { name: "evaluate", line: 1200 }; return __func(_, this, arguments, evaluate, 3, __frame, function __$evaluate() {
      if ((typeof s !== "string")) {
        return _(null, s); } ;
